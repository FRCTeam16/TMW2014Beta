...
DriveTrain::DriveTrain() : Subsystem("DriveTrain") {
	...
	CrabSpeedTwist = RobotMap::CrabSpeedTwist;
...
void DriveTrain::SetSteerSetpoint(float setpoint, AnalogInput* actual, float offset, PIDController* PIDCon, CANJaguar* steer, int turns, int &inv, bool UseShortcut) {
