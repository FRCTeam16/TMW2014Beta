...
//	resetCams = new ResetCams();
	//cout << "Shooter Constructor Complete" << endl;
}
...
void Shooter::RunCams(float output, bool forceRun) {
	...
	camLeft->Set(f_output);
	camRight->Set(-f_output);
...
void Shooter::SetResetCamComplete(bool value) {
	resetCamComplete = value;
}
void Shooter::SetFireFlag(bool value) {
	fireFlag = value;
}
void Shooter::SetFireDelayFlag(bool value) {
	fireDelayFlag = value;
}
